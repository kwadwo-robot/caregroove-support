    ...
    <div class="container">
        ...
        <div style="display: flex; gap: 2rem; align-items: center; margin-bottom: 3rem;" data-aos="fade-up">
            <div style="flex: 1; min-width: 0;">
                <img src="/public/images/support-workers.jpg" alt="Care Workers" style="width: 100%; height: 300px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
            </div>
            <div style="flex: 1; min-width: 0;">
        ...
        <div style="display: flex; gap: 2rem; align-items: center; margin-bottom: 3rem; flex-direction: row-reverse;" data-aos="fade-up">
            <div style="flex: 1; min-width: 0;">
                <img src="/public/images/elderly-care.jpg" alt="Senior Care Workers" style="width: 100%; height: 300px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
            </div>
            <div style="flex: 1; min-width: 0;">
        ...
        <div style="display: flex; gap: 2rem; align-items: center; margin-bottom: 3rem;" data-aos="fade-up">
            <div style="flex: 1; min-width: 0;">
                <img src="/public/images/homecare.jpg" alt="Care Coordinators" style="width: 100%; height: 300px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
            </div>
            <div style="flex: 1; min-width: 0;">
        ...
        <div style="display: flex; gap: 2rem; align-items: center; margin-bottom: 3rem; flex-direction: row-reverse;" data-aos="fade-up">
            <div style="flex: 1; min-width: 0;">
                <img src="/public/images/Y5rjK4iIHncG.jpeg" alt="Specialist Care Professionals" style="width: 100%; height: 300px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
            </div>
            <div style="flex: 1; min-width: 0;">
            ...
            <div style="flex: 1; min-width: 0;">
                <div class="service-card" style="background: #f0f8ff; border: 2px solid #0066cc; box-shadow: 0 4px 15px rgba(0, 102, 204, 0.1);" data-aos="fade-left">
                    ...
                    <p style="margin-bottom: 1.5rem; display: flex; align-items: center; color: #333;">
                        ...
                        <a href="tel:07466975751" style="color: #0066cc; text-decoration: none; font-weight: 600; font-size: 0.95rem;">07466975751</a>
                    </p>
