            ...
            <div class="top-bar-inner">
                ...
                <div class="top-bar-right">
                    <div class="top-bar-item">
                        ...
                        <a href="tel:07466975751">07466 975751</a>
                    </div>
                    <div class="top-bar-item">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="/images/logo.png" alt="CareGroove Support Ltd" style="height: 50px; width: auto;">
            </a>
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <div class="footer-contact">
                        ...
                        <p style="display: flex; align-items: center;"><i class="fas fa-phone" style="color: #0066cc; margin-right: 0.5rem; flex-shrink: 0;"></i><a href="tel:07466975751" style="color: #ccc;">07466975751</a></p>
