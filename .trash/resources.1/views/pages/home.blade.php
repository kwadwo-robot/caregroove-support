...
<div class="hero-slider" id="heroSlider">
    <!-- Slide 1 -->
    <div class="hero-slide active" style="background-image: url('/images/hero-care.jpg');">
        ...
        <div class="container hero-content">
            <div class="hero-text">
                ...
                <div class="hero-btns">
                    ...
                    <a href="{{ route('services') }}" class="hero-btn-outline">Our Services</a>
                </div>
            </div>
        </div>
    </div>
    <!-- Slide 2 -->
    <div class="hero-slide" style="background-image: url('/images/elderly-care.jpg');">
        <div class="hero-slide-overlay"></div>
        <div class="container hero-content">
            <div class="hero-text">
    ...
    <!-- Slide 3 -->
    <div class="hero-slide" style="background-image: url('/images/homecare.jpg');">
        <div class="hero-slide-overlay"></div>
        <div class="container hero-content">
            <div class="hero-text">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="0">
                <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.08); transition: all 0.3s ease; height: 100%; display: flex; flex-direction: column;">
                    <img src="/images/Y5rjK4iIHncG.jpeg" alt="Personal Care" style="width: 100%; height: 200px; object-fit: cover;">
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
                <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.08); transition: all 0.3s ease; height: 100%; display: flex; flex-direction: column;">
                    <img src="/images/aMYEBOI4KpAj.jpeg" alt="Dementia Care" style="width: 100%; height: 200px; object-fit: cover;">
                    <div style="padding: 2rem; flex-grow: 1; display: flex; flex-direction: column;">
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
                <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.08); transition: all 0.3s ease; height: 100%; display: flex; flex-direction: column;">
                    <img src="/images/eIRIeO92fErJ.jpeg" alt="Live-In Care" style="width: 100%; height: 200px; object-fit: cover;">
                    <div style="padding: 2rem; flex-grow: 1; display: flex; flex-direction: column;">
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="0">
                <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.08); transition: all 0.3s ease; height: 100%; display: flex; flex-direction: column;">
                    <img src="/images/bAkXpuStcNBT.jpeg" alt="Respite Care" style="width: 100%; height: 200px; object-fit: cover;">
                    <div style="padding: 2rem; flex-grow: 1; display: flex; flex-direction: column;">
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
                <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.08); transition: all 0.3s ease; height: 100%; display: flex; flex-direction: column;">
                    <img src="/images/cKQMZnozVADj.jpg" alt="Palliative Care" style="width: 100%; height: 200px; object-fit: cover;">
                    <div style="padding: 2rem; flex-grow: 1; display: flex; flex-direction: column;">
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
                <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.08); transition: all 0.3s ease; height: 100%; display: flex; flex-direction: column;">
                    <img src="/images/VwDrqtAJr4RD.jpg" alt="Hospital Discharge" style="width: 100%; height: 200px; object-fit: cover;">
                    <div style="padding: 2rem; flex-grow: 1; display: flex; flex-direction: column;">
    ...
    <div class="container">
        <div class="row align-items-center" style="display: flex; align-items: center; gap: 3rem;">
            ...
            <div class="col-lg-6" data-aos="fade-left" style="flex: 1;">
                <img src="/images/elderly-care.jpg" alt="About CareGroove" style="width: 100%; border-radius: 12px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15); display: block;">
            </div>
        </div>
    </div>
</section>
