    ...
    <div class="container">
        <div style="display: flex; gap: 3rem; align-items: center;">
            <div data-aos="fade-left" style="flex: 1; display: flex; align-items: center;">
                <img src="/images/eIRIeO92fErJ.jpeg" alt="Visiting Care" style="width: 100%; height: 480px; object-fit: cover; border-radius: 12px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);">
            </div>
...
<section style="padding: 80px 0;">
    <div class="container">
        <div style="display: flex; gap: 3rem; align-items: center;">
            <div data-aos="fade-left" style="flex: 1; display: flex; align-items: center;">
                <img src="/images/Y5rjK4iIHncG.jpeg" alt="Personal Care" style="width: 100%; height: 480px; object-fit: cover; border-radius: 12px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);">
            </div>
...
<section style="padding: 80px 0;">
    <div class="container">
        <div style="display: flex; gap: 3rem; align-items: center;">
            <div data-aos="fade-left" style="flex: 1; display: flex; align-items: center;">
                <img src="/images/cKQMZnozVADj.jpg" alt="Domestic Care" style="width: 100%; height: 480px; object-fit: cover; border-radius: 12px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);">
            </div>
            <div data-aos="fade-right" style="flex: 1; background: linear-gradient(135deg, #0066cc 0%, #0052a3 100%); color: white; padding: 3rem; border-radius: 12px;">
...
<section style="padding: 80px 0;">
    <div class="container">
        <div style="display: flex; gap: 3rem; align-items: center;">
            <div data-aos="fade-left" style="flex: 1; display: flex; align-items: center;">
                <img src="/images/respite-care.jpg" alt="Respite Care" style="width: 100%; height: 480px; object-fit: cover; border-radius: 12px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);">
            </div>
            <div data-aos="fade-right" style="flex: 1; background: linear-gradient(135deg, #2d8659 0%, #1f5a3f 100%); color: white; padding: 3rem; border-radius: 12px;">
