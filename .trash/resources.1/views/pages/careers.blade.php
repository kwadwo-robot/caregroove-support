...
<section style="padding: 80px 0; background: #f8f9fa;">
    <div class="container">
        ...
        <div style="display: flex; gap: 2rem; align-items: center; margin-bottom: 3rem; flex-direction: row-reverse;" data-aos="fade-up">
            <div style="flex: 1; min-width: 0;">
                <img src="{{ asset('images/elderly-care.jpg') }}" alt="Senior Care Workers" style="width: 100%; height: 300px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
            </div>
            <div style="flex: 1; min-width: 0;">
        ...
        <div style="display: flex; gap: 2rem; align-items: center; margin-bottom: 3rem;" data-aos="fade-up">
            <div style="flex: 1; min-width: 0;">
                <img src="{{ asset('images/homecare.jpg') }}" alt="Care Coordinators" style="width: 100%; height: 300px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
            </div>
            <div style="flex: 1; min-width: 0;">
        ...
        <div style="display: flex; gap: 2rem; align-items: center; margin-bottom: 3rem; flex-direction: row-reverse;" data-aos="fade-up">
            <div style="flex: 1; min-width: 0;">
                <img src="{{ asset('images/Y5rjK4iIHncG.jpeg') }}" alt="Specialist Care Professionals" style="width: 100%; height: 300px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
            </div>
            <div style="flex: 1; min-width: 0;">
