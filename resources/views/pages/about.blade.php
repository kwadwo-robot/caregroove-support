...
@section('content')
<!-- Hero Section -->
<section style="background: linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)), url('/images/vector-personal-care.webp') center/cover no-repeat; min-height: 420px; display: flex; align-items: center; color: white;">
    <div class="container">
    ...
    <div class="container">
        <div style="display: flex; align-items: center; gap: 4rem; flex-wrap: wrap;">
            <div style="flex: 1; min-width: 280px;" data-aos="fade-right">
                <img src="/images/vector-personal-care.webp" alt="Our Mission" style="width: 100%; border-radius: 14px; box-shadow: 0 10px 30px rgba(0,0,0,0.12);">
            </div>
...
<section style="padding: 80px 0; background: #f8faff;">
    <div class="container">
        <div style="display: flex; align-items: center; gap: 4rem; flex-wrap: wrap;">
            ...
            <div style="flex: 1; min-width: 280px;" data-aos="fade-left">
                <img src="/images/vector-personal-care.webp" alt="Our Vision" style="width: 100%; border-radius: 14px; box-shadow: 0 10px 30px rgba(0,0,0,0.12);">
            </div>
        </div>
    </div>
</section>
